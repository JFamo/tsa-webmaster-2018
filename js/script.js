...
if(document.getElementById('courses_techlink') != null){
	...
	document.getElementById('courses_techlink').onclick = function(){ switchCourses("courses_techlink","Technology and Engineering Courses", "Technology and Engineering classes teach students about the technological world in which we live. The courses within this academy can provide students skills ranging from architectural design principles and robotics assembly lines, to photography and photo editing. Students can choose these classes as electives to their schedule.","tech.html",true); }
	document.getElementById('courses_sciencelink').onclick = function(){ switchCourses("courses_sciencelink","Science Courses", "The science academy requires students to go through Biology (for the Keystones) and Chemistry, offering Physics courses, Environmental Science, Astronomy, and Psychology as optionals. Students can double up on science courses, many of which are AP.","science.html",true); }
	document.getElementById('courses_mathlink').onclick = function(){ switchCourses("courses_mathlink","Mathematics Courses", "A steady path from Algebra 1 to AP Calculus or AP Statistics characterizes the mathematics academy. Students learn algebra, trigonometry and geometry, calculus, and can optionally learn probability and statistics. Doubling up on courses or taking one over the summer through the Montgomery Community College is permitted.","math.html",true); }
	document.getElementById('courses_businesslink').onclick = function(){ switchCourses("courses_businesslink","Business Courses", "Business classes include those that teach accounting, programming, Microsoft Office applications, financial management and entrepreneurship, as well as some marketing and civil law concepts. Students can choose these classes as electives to their schedule.
","business.html",true); }
